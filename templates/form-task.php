...
<main class="content__main">
        ...
        <form class="form"   method="post" autocomplete="off">
            ...
            <div class="form__row">
                ...
                <?php if (isset($errors)) {
                    $classname = $errors['project'] ? "form__input--error" : "";
                } ?>
            ...
            <div class="form__row">
                ...
                <?php if (isset($errors)) {
                    $classname = $errors['date_finish'] ? "form__input--error" : "";
                } ?>
            ...
            <div class="form__row">
                ...
                <div class="form__input-file">
                    <input class="visually-hidden" type="file" name="file" id="file" value="<?= $_POST['file'] ?? null;?>">
                    <?php if (isset($errors)) {
                        if ($errors["file"]) : ?>
