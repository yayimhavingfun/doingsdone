    ...
    <div class="tasks-controls">
        ...
        <label class="checkbox">
            <!--добавить сюда атрибут "checked", если переменная $show_complete_tasks равна единице-->
             <input class="checkbox__input visually-hidden show_completed" type="checkbox" name="show_complete_tasks" <?php if ($show_complete_tasks == 1) : ?> checked <?php endif; ?>>
    ...
    <table class="tasks">
        ...
        <?php if ($show_complete_tasks == 0 && $task['status'] == 1) {
            ...
            <tr class="tasks__item task
                ...
                <td class="task__date"><?php if (isset($task['date_finish'])) {echo htmlspecialchars($task['date_finish']);} ?></td>
            </tr>
            <?php endif; ?>
            <?php endif; ?>
        <?php endforeach; ?>
